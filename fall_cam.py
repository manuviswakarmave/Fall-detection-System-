...
def fall_camera():
    ...
    account_sid ='ACbd7d1d7cfb9b28e5d53a4615c02dbd30'
    auth_token ='5eb1e2212c4992c47e15a38ebb11c47f'
    ...
    out_video_name = "C:\\Users\\Manu\\Project Gui\\GUI\\result"
    ...
    while(cap.isOpened):
        ...
        if ret:
            ...
            if fall_datected ==1 and fall_frame < 50:
                ...
                if fall_frame == 50:
                 out.release()
                 p3 = threading.Thread(target=tel_msg)    
                 p3.start()
                 #tel_msg() 
                 fall_datected = 0
                 fall_frame = -1000 
            ...
            if empty:
                ...
                if frame_count % 5000 == 0:
                    #make_msg()
                    p4 = threading.Thread(target=make_msg)    
                    p4.start()
                    ...
                    if not len(cordinates) == 0:
                       ...
                       # print(iou)
                        ...
                        if iou >= 0.15:
                            ...
                            if flag == 0:
                                flag = 1
                                p5 = threading.Thread(target=make_call)    
                                p5.start()
                        ...
                        if flag == 0:
                                flag = 1
                                p6 = threading.Thread(target=make_call)    
                                p6.start()
